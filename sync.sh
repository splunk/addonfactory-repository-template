...
do
    ...
    then
        ...
        curl api -X PATCH -H "Accept: application/vnd.github.v3+json" https://api.github.com/repos/$REPOORG/$REPO/branches/main/protection -d '{"dismissal_restrictions": {},"dismiss_stale_reviews": false,"require_code_owner_reviews": true,"required_approving_review_count": 1}'
